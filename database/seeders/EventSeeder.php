    ...
    public function run()
    {
        ...
        DB::table('events')->insert([
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36051135103978 -7.751823562463178)')"),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.37782533410076 -7.770251638746828)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36588792192126 -7.791903826254844)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36524862738847 -7.7955240296755)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36457646626006 -7.8036826323673365)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.43204265428571 -7.925889639813071)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.4615208258146 -8.10575836644449)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.42825000067224 -7.64684972577411)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.42181334297364 -7.6203681463691915)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.42148185027408 -7.606597657727463)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.45589624669641 -7.584781751348995)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.38430137378029 -7.795475867129514)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36775906414765 -7.800486716182875)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36764988050301 -7.799930108450771)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36477883416917 -7.801311700759353)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36454901245968 -7.802209467288816)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36310595255604 -7.8117809536176575)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.35931589602912 -7.809820230150456)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.36956694493706 -7.749108634722534)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.41935511534935 -7.748971553595012)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.41633181878827 -7.751246746715519)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.49139855375093 -7.7511342341190215)')"),
                'start_date' => date('Y-m-d H:i:s'),
                'end_date' => date('Y-m-d H:i:s', strtotime("+3 days")),
                "description" => $faker->text(),
                'content' => $faker->randomHtml(2, 3),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.40141912419814 -7.781336868828283)')"),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.60214696749847 -7.9617187575403925)')"),
            ...
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(110.14206552364774 -7.894417885238265)')"),
        ...
        DB::table('events')->insert(
            [
                ...
                "position" => DB::raw("ST_GeomFromText('POINT(135.00128814750178 -23.762681285706176)')"),
                'start_date' => date('Y-m-d H:i:s', strtotime("+365 days")),
                'end_date' => date('Y-m-d H:i:s', strtotime("+368 days")),
