        ...
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <div class="mb-5 d-flex">
                    ...
                    <a href="/admin/dashboard?status=upcoming" class="mx-1 btn btn-sm rounded-pill {{ $current_status == 'upcoming' ? 'btn-primary' : 'btn-outline-primary' }}">Upcoming</a>
                    ...
                    <a href="/admin/dashboard?status=upcoming&date=week" class="{{ $current_date == 'week' ? 'btn-success' : 'btn-outline-success' }} btn btn-sm rounded-pill">This
                        week</a>
                    <a href="/admin/dashboard?status=upcoming&date=month" class="{{ $current_date == 'month' ? 'btn-success' : 'btn-outline-success' }} btn btn-sm mx-1 rounded-pill">This
                        month</a>
                    <a href="/admin/dashboard?status=upcoming&date=year" class="{{ $current_date == 'year' ? 'btn-success' : 'btn-outline-success' }} btn btn-sm rounded-pill">This
                        year</a>
                    @endif
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <img style="max-height: 400px;object-fit: contain;" class="img-fluid w-100" src="{{ $event->photo }}" alt="Card image cap">
                        <div class="card-body">
