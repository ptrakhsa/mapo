...
<div id="app" class="row bg-transparent">
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            ...
            <div class="d-flex flex-wrap mt-2">
                <button v-for="(pop,i) in popularPlaces" :key="i" v-text="pop.name" @click="getEventsByPopularPlaces(pop.id)" class="btn btn-sm btn-outline-primary mx-1 my-1 rounded-pill"></button>
            </div>
        </div>
    </div>
    ...
    <div class="container-1">
        <input @keyup.enter="search" v-model="keyword" autocomplete="off" @click="openNav()" type="search" id="search" placeholder="Search .." />
    </div>
    ...
    <div id="bottom-sheet">
        <div id="event-list">
            <div class="px-2 mt-1 mb-2">
                <div style="margin-bottom: 25px;overflow: auto; white-space: nowrap;" class=" py-2">
                    ...
                    <div class="d-inline-block">
                        <button @click="toggleCategory(0)" :class="{ 'btn-primary': filter.cat == 0 }" class="btn btn-sm btn-outline-primary rounded-pill">All</button>
                        <button v-for="(category,i) in categories" :key="i" @click="toggleCategory(category.id)" :class="{ 'btn-primary': filter.cat == category.id }" v-text="category.name" class="mx-1 btn btn-sm btn-outline-primary rounded-pill"></button>
                    </div>
                    ...
                    <div class="btn-group d-inline-block">
                        <button @click="toggleDate(1)" :class="{ 'btn-success': filter.date == 1 }" class="btn btn-sm btn-outline-success rounded-pill">this week</button>
                        <button @click="toggleDate(2)" :class="{ 'btn-success': filter.date == 2 }" class="btn btn-sm btn-outline-success mx-1 rounded-pill">this month</button>
                        <button @click="toggleDate(3)" :class="{ 'btn-success': filter.date == 3 }" class="btn btn-sm btn-outline-success rounded-pill">this year</button>
                    </div>
                </div>
            </div>
            ...
            <div v-for="(event,i) in events" :key="i" v-if="isLoading == false" @click="getEventDetail(event)">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-8">
                            <div class="card-content ">
                                ...
                                <small class="badge bg-light-primary mb-1" style="font-size: 13px;" v-text="event.category_name"></small>
