...
@section('content')
    ...
    <div class="row no-gutter bg-white" id="app">
        ...
        <div id="card-list-view">
            <div v-if="showDetail == false" class="px-2 mt-3">
            ...
            <div v-for="(event,i) in events" :key="i" v-if="isLoading == false && showDetail == false"
                ...
                <div class="card px-3 py-3" style="cursor: pointer;">

                    <div class="row">
                        <div class="col-4">
                            <img :src="event.photo" width="100" height="100" class="rounded-start">
                        </div>

                        <div class="col-8">
                            <div class="card-content">
                                <div class="card-body d-block">
                                    <h4 class="card-title" v-text="event.name"></h4>
                                    <span class="badge bg-light-primary mb-3" v-text="event.category_name"></span>
