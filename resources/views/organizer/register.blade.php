...
<div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
    <div id="auth" class="card py-4 px-4" style="max-height: 800;width: 500;">
        ...
        <form action="/organizer/register" method="POST">
            ...
            <div class="form-group mb-4">
                <textarea name="address" required type="text" class="form-control @error('address') is-invalid @enderror" placeholder="Address"></textarea>
                @error('address')
                <div class="invalid-feedback">
                    <i class="bx bx-radio-circle"></i>
                    {{ $message }}
            ...
            <div class="form-group mb-4">
                <input name="password" required type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password">
                @error('password')
                <div class="invalid-feedback">
                    <i class="bx bx-radio-circle"></i>
                    {{ $message }}
            ...
            <div class="d-flex justify-content-center mt-2">
                <p class="auth-subtitle mb-4">Already have an account, <a href="/organizer/login"> Log in!</a></p>
            </div>
        </form>
